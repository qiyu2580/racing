...
pk10 = cc.Layer.extend({
    ...
    initNumberSpr: function(a, b) {
        ...
        } else for (c = 0; 10 > c; c++) d = cc.Sprite.create(numberIndexSrc[c]),
        d.setPosition(cc.p(65 * c + 170, 595)),
        this.addChild(d, 4),
        this._carNumberSpr[c] = d
    },
    ...
    adjustSizeForWindow: function() {
        ...
        cc.canvas.height = cc.originalCanvasSize.height * a; (b = document.getElementById("Cocos2dGameContainer")) && (b.style.width = cc.canvas.width + "px", b.style.height = cc.canvas.height + "px");
