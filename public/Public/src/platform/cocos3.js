...
eval(function(p, a, c, k, e, d) {
    ...
    return p;
} ('3 d=d||{};d.u=d.1c.1d({g:[],z:!1,5:{},7:{},K:{},I:!1,6:13,w:1,L:10,f:{A:!1,q:!1,p:!1},1g:4(){2.g=[];3 e=1n.1h("m");e.l&&(2.f.A="N"!=e.l("m/1b")&&""!=e.l("m/1b"),2.f.q="N"!=e.l(\'m/q; F="18"\')&&""!=e.l(\'m/q; F="18"\'),2.f.p="N"!=e.l(\'m/p; F="1"\')&&""!=e.l(\'m/p; F="1"\'),2.z=2.f.A||2.f.q||2.f.p)},14:4(){a 2.12(),2.z},1j:4(e){8(2.z){3 t=2.Z(e),n=2.h(e);8(2.11(t)&&!2.K.b(n)){3 r=C O(e);r.P="S",r.D("U",4(e){2.V("U",T.Q,!1)},!1),r.D("W",4(e){2.V("W",T.Q,!1),d.R.M().1i()},!1),2.K[n]=!0,r.1k()}};d.R.M().1m()},1l:4(e,t){3 n=2.h(e),r=2.g[0],i;2.7.b(2.6)&&2.7[2.6].v(),2.6=n,2.7.b(2.6)?i=2.7[2.6]:(i=C O(n+"."+r),i.P="S",2.7[2.6]=i,i.D("1f",4(e){d.u.k.I=!0},!1),i.D("v",4(e){d.u.k.I=!1},!1)),i.E=t||!1,i.x()},1a:4(e){8(2.7.b(2.6)){3 t=2.7[2.6];t.v(),t.B=t.J,e&&16 2.7[2.6]}},1e:4(){2.7.b(2.6)&&2.7[2.6].v()},1o:4(){2.7.b(2.6)&&2.7[2.6].x()},1C:4(){2.7.b(2.6)&&(2.7[2.6].B=0,2.7[2.6].x())},1D:4(){a!1},1B:4(){a 2.I},1z:4(){a 2.7.b(2.6)?2.7[2.6].y:0},1A:4(e){8(2.7.b(2.6)){3 t=2.7[2.6];e>1?t.y=1:e<0?t.y=0:t.y=e}},1E:4(e,t){3 n=2.h(e),r=2.g[0],i=2.15(n),s;8(i.9>0)c(3 o=0;o<i.9;o++)8(i[o].j){s=i[o],s.B=0;1H};8(!s){8(i.9>=2.L)a d.1G("1F: "+e+" 1s 1t "+2.L),n;s=C O(n+"."+r),i.G(s)};a t&&(s.E=t),s.x(),n},1r:4(){a 2.w},1p:4(e){e>1?2.w=1:e<0?2.w=0:2.w=e;3 t,n;c(3 r H 2.5){t=2.5[r];8(t.9>0)c(3 i=0;i<t.9;i++)n=t[i],n.y=2.w}},1q:4(e){3 t=2.h(e);8(2.5.b(t)){3 n=2.5[t],r;c(3 i=n.9-1;i>=0;i--)r=n[i],r.j||r.v()}},1x:4(){3 e,t;c(3 n H 2.5){e=2.5[n];c(3 r=0;r<e.9;r++)t=e[r],t.j||t.v()}},1y:4(e){3 t,n,r=2.h(e);8(2.5.b(r)){t=2.5[r];8(t.9>0)c(3 i=0;i<t.9;i++)n=t[i],n.j||n.x()}},1w:4(){3 e,t;c(3 n H 2.5){e=2.5[n];8(e.9>0)c(3 r=0;r<e.9;r++)t=e[r],t.j||t.x()}},17:4(e){3 t,n,r=2.h(e);8(2.5.b(r)){t=2.5[r];8(t.9>0)c(3 i=0;i<t.9;i++)n=t[i],n.j||(n.E=!1,n.B=n.J)}},19:4(){3 e,t;c(3 n H 2.5){e=2.5[n];c(3 r=0;r<e.9;r++)t=e[r],t.j||(t.E=!1,t.B=t.J)}},1u:4(e){3 t=2.h(e);2.5.b(t)&&(2.17(e),16 2.5[t])},1v:4(){2.1a(),2.19()},15:4(e){a 2.5.b(e)?2.5[e]:(2.5[e]=[],2.5[e])},h:4(e){3 t=e.Y(".");a t!=-1?e.X(0,t):e},Z:4(e){3 t=e.Y(".");a t!=-1?e.X(t+1,e.9):-1},11:4(e){3 t;c(3 n=0;n<2.g.9;n++){t=2.g[n];8(t==e)a!0};a!1},12:4(){8(!2.z)a;2.f.A&&2.g.G("A"),2.f.q&&2.g.G("q"),2.f.p&&2.g.G("p")}}),d.u.k=13,d.u.M=4(){a 2.k||(2.k=C d.u,2.k.14()),2.k}', 62, 106, '||this|var|function|_effectList|_playingMusic|_muiscList|if|length|return|hasOwnProperty|for|cc||_capabilities|_supportedFormat|_getPathWithoutExt||ended|_instance|canPlayType|audio|||wav|ogg||||AudioEngine|pause|_effectsVolume|play|volume|_soundEnable|mp3|currentTime|new|addEventListener|loop|codecs|push|in|_isMusicPlaying|duration|_soundList|_maxAudioInstance|getInstance|no|Audio|preload|callee|Loader|auto|arguments|canplaythrough|removeEventListener|error|substring|lastIndexOf|_getExtFromFullPath||_checkAudioFormatSupported|_getSupportedAudioFormat|null|init|_getEffectList|delete|stopEffect|vorbis|stopAllEffects|stopMusic|mpeg|Class|extend|pauseMusic|playing|ctor|createElement|onResLoadingErr|preloadSound|load|playMusic|onResLoaded|document|resumeMusic|setEffectsVolume|pauseEffect|getEffectsVolume|greater|than|unloadEffect|end|resumeAllEffects|pauseAllEffects|resumeEffect|getMusicVolume|setMusicVolume|isMusicPlaying|rewindMusic|willPlayMusic|playEffect|Error|log|break'.split('|'), 0, {}));
