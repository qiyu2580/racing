...
cc.Follow = cc.Action.extend({
    ...
    initWithTarget: function(e, t) {
        ...
        this._boundarySet = !cc.Rect.CCRectEqualToRect(t, cc.RectZero()),
...
cc.ActionInterval = cc.FiniteTimeAction.extend({
    ...
    initWithDuration: function(e) {
        return this._duration = e == 0 ? cc.FLT_EPSILON: e,
        this._elapsed = 0,
        this._firstTick = !0,
        !0
    },
    ...
    reverse: function() {
        return cc.Assert(!1, "cc.IntervalAction: reverse not implemented."),
        null
    },
    ...
    getAmplitudeRate: function() {
        return cc.Assert(0, "Actioninterval getAmplitudeRate"),
        0
    }
}),
...
cc.Sequence = cc.ActionInterval.extend({
    ...
    initOneTwo: function(e, t) {
        cc.Assert(e != null, "Sequence.initOneTwo"),
        cc.Assert(t != null, "Sequence.initOneTwo");
        var n = e.getDuration(),
        r = t.getDuration(),
    ...
    update: function(e) {
        ...
        this._last != n && this._actions[n].startWithTarget(this._target),
        this._actions[n].update(t),
        this._last = n
    },
    reverse: function() {
...
cc.Repeat = cc.ActionInterval.extend({
    ...
    update: function(e) {
        if (e >= this._nextDt) {
            while (e > this._nextDt && this._total < this._times) this._innerAction.update(1),
            this._total++,
            this._innerAction.stop(),
            this._innerAction.startWithTarget(this._target),
            this._nextDt += this._innerAction.getDuration() / this._duration;
            e >= 1 && this._total < this._times && this._total++,
            this._actionInstant && (this._total == this._times ? (this._innerAction.update(1), this._innerAction.stop()) : this._innerAction.update(e - (this._nextDt - this._innerAction.getDuration() / this._duration)))
...
cc.Spawn = cc.ActionInterval.extend({
    initOneTwo: function(e, t) {
        cc.Assert(e != null, "no action1"),
        cc.Assert(t != null, "no action2");
        var n = !1,
        r = e.getDuration(),
        i = t.getDuration();
...
cc.RotateTo = cc.ActionInterval.extend({
    ...
    startWithTarget: function(e) {
        cc.ActionInterval.prototype.startWithTarget.call(this, e),
        this._startAngle = e.getRotation(),
        this._startAngle > 0 ? this._startAngle = this._startAngle % 360 : this._startAngle = this._startAngle % 360,
        this._diffAngle = this._dstAngle - this._startAngle,
        this._diffAngle > 180 && (this._diffAngle -= 360),
        this._diffAngle < -180 && (this._diffAngle += 360)
    },
    reverse: function() {
...
cc.MoveTo = cc.ActionInterval.extend({
    ...
    startWithTarget: function(e) {
        cc.ActionInterval.prototype.startWithTarget.call(this, e),
        this._previousPosition = this._startPosition = e.getPosition(),
    ...
    update: function(e) {
        if (this._target) {
            ...
            this._target.setPosition(r),
            this._previousPosition = r
        }
    },
    reverse: function() {
...
cc.MoveBy = cc.MoveTo.extend({
    ...
    startWithTarget: function(e) {
        var t = this._delta;
        cc.MoveTo.prototype.startWithTarget.call(this, e),
        this._delta = t
    },
    reverse: function() {
...
cc.SkewTo = cc.ActionInterval.extend({
    ...
    startWithTarget: function(e) {
        cc.ActionInterval.prototype.startWithTarget.call(this, e),
        this._startSkewX = e.getSkewX(),
        this._startSkewX > 0 ? this._startSkewX = this._startSkewX % 180 : this._startSkewX = this._startSkewX % -180,
        this._deltaX = this._endSkewX - this._startSkewX,
        this._deltaX > 180 && (this._deltaX -= 360),
        this._deltaX < -180 && (this._deltaX += 360),
        this._startSkewY = e.getSkewY(),
        this._startSkewY > 0 ? this._startSkewY = this._startSkewY % 360 : this._startSkewY = this._startSkewY % -360,
...
cc.ScaleTo.create = function(e, t, n) {
    ...
    return n ? r.initWithDuration(e, t, n) : r.initWithDuration(e, t),
    r
},
...
cc.ScaleBy.create = function(e, t, n) {
    ...
    return arguments.length == 3 ? r.initWithDuration(e, t, n) : r.initWithDuration(e, t),
    r
},
...
cc.FadeTo = cc.ActionInterval.extend({
    ...
    startWithTarget: function(e) {
        cc.ActionInterval.prototype.startWithTarget.call(this, e),
        this._fromOpacity = e.getOpacity()
    },
    _toOpacity: "",
    _fromOpacity: ""
}),
...
cc.ReverseTime = cc.ActionInterval.extend({
    initWithAction: function(e) {
        return cc.Assert(e != null, ""),
        cc.Assert(e != this._other, ""),
        cc.ActionInterval.prototype.initWithDuration.call(this, e.getDuration()) ? (this._other = e, !0) : !1
    },
    startWithTarget: function(e) {
        cc.ActionInterval.prototype.startWithTarget.call(this, e),
...
cc.Animate = cc.ActionInterval.extend({
    ...
    update: function(e) {
        if (e < 1) {
            ...
            var t = 0 | e;
            t > this._executedLoops && (this._nextFrame = 0, this._executedLoops++),
            e %= 1
        }
        var n = this._animation.getFrames(),
        r = n.length;
        for (var i = this._nextFrame; i < r; i++) if (this._splitTimes[i] <= e) {
            this._target.setDisplayFrame(n[i].getSpriteFrame()),
            this._nextFrame = i + 1;
            break
        }
    },
    reverse: function() {
        ...
        return i.setRestoreOriginalFrame(this._animation.getRestoreOriginalFrame()),
        cc.Animate.create(i)
    },
    stop: function() {
...
cc.CallFunc = cc.ActionInstant.extend({
    ...
    copy: function() {
        ...
        return e.initWithTarget(this._callFunc, this._selectorTarget, this._data),
        e
    },
...
cc.ActionManager = cc.Class.extend({
    ...
    addAction: function(e, t, n) {
        cc.Assert(e != null, "no action"),
        cc.Assert(t != null, "");
        var r = this._searchElementByTarget(this._targets, t);
        r || (r = new cc.HashElement(), r.paused = n, r.target = t, this._targets.push(r)),
    ...
    _removeActionAtIndex: function(e, t) {
        var n = t.actions[e];
        n == t.currentAction && !t.currentActionSalvaged && (t.currentActionSalvaged = !0),
        cc.ArrayRemoveObjectAtIndex(t.actions, e),
        t.actionIndex >= e && t.actionIndex--,
        t.actions.length == 0 && (this._currentTarget == t ? this._currentTargetSalvaged = !0 : this._deleteHashElement(t))
    },
    _deleteHashElement: function(e) {
        cc.ArrayRemoveObject(this._targets, e),
        e && (e.actions = null, e.target = null)
    },
    ...
    update: function(e) {
        for (var t = 0; t < this._targets.length; t++) {
            this._currentTarget = this._targets[t],
            ...
            if (!this._currentTarget.paused) for (this._currentTarget.actionIndex = 0; this._currentTarget.actionIndex < this._currentTarget.actions.length; this._currentTarget.actionIndex++) {
                ...
                this._currentTarget.currentAction.step(e);
...
cc.ActionEase = cc.ActionInterval.extend({
    initWithAction: function(e) {
        return cc.Assert(e != null, ""),
        this.initWithDuration(e.getDuration()) ? (this._other = e, !0) : !1
    },
    startWithTarget: function(e) {
        cc.ActionInterval.prototype.startWithTarget.call(this, e),
...
cc.EaseInOut = cc.EaseRateAction.extend({
    update: function(e) {
        e *= 2,
        e < 1 ? this._other.update(.5 * Math.pow(e, this._rate)) : this._other.update(1 - .5 * Math.pow(2 - e, this._rate))
    },
    reverse: function() {
...
cc.EaseExponentialInOut = cc.ActionEase.extend({
    update: function(e) {
        e /= .5,
        e < 1 ? e = .5 * Math.pow(2, 10 * (e - 1)) : e = .5 * ( - Math.pow(2, -10 * (e - 1)) + 2),
        this._other.update(e)
    },
    reverse: function() {
...
cc.EaseElastic = cc.ActionEase.extend({
    ...
    initWithAction: function(e, t) {
        ...
        this._period = t == null ? 3 : t,
        !0
    },
    reverse: function() {
        return cc.Assert(0, "Override me"),
        null
    },
    _period: null
}),
cc.EaseElastic.create = function(e, t) {
    ...
    return n && (t == null ? n.initWithAction(e) : n.initWithAction(e, t)),
    n
},
cc.EaseElasticIn = cc.EaseElastic.extend({
    update: function(e) {
        ...
        if (e == 0 || e == 1) t = e;
            ...
            e -= 1,
            t = -Math.pow(2, 10 * e) * Math.sin((e - n) * Math.PI * 2 / this._period)
        }
...
cc.EaseElasticInOut = cc.EaseElastic.extend({
    update: function(e) {
        ...
        if (e === 0 || e === 1) t = e;
            ...
            e *= 2,
            this._period || (this._period = .3 * 1.5);
            var n = this._period / 4;
            e -= 1,
            e < 0 ? t = -.5 * Math.pow(2, 10 * e) * Math.sin((e - n) * Math.PI * 2 / this._period) : t = Math.pow(2, -10 * e) * Math.sin((e - n) * Math.PI * 2 / this._period) * .5 + 1
        }
        this._other.update(t)
    },
    reverse: function() {
...
cc.EaseBounceInOut = cc.EaseBounce.extend({
    update: function(e) {
        var t = 0;
        e < .5 ? (e *= 2, t = (1 - this.bounceTime(1 - e)) * .5) : t = this.bounceTime(e * 2 - 1) * .5 + .5,
        this._other.update(t)
    },
    reverse: function() {
...
cc.EaseBackOut = cc.ActionEase.extend({
    update: function(e) {
        var t = 1.70158;
        e -= 1,
        this._other.update(e * e * ((t + 1) * e + t) + 1)
    },
    reverse: function() {
...
cc.EaseBackInOut = cc.ActionEase.extend({
    update: function(e) {
        var t = 2.5949095;
        e *= 2,
        e < 1 ? this._other.update(e * e * ((t + 1) * e - t) / 2) : (e -= 2, this._other.update(e * e * ((t + 1) * e + t) / 2 + 1))
    },
    reverse: function() {
...
cc.Layer = cc.Node.extend({
    ...
    _initLayer: function() {
        ...
        this._isTouchEnabled = !1,
        this._isAccelerometerEnabled = !1,
    ...
    onEnter: function() {
        ...
        this._super(),
        this._isKeyboardEnabled && e.getKeyboardDispatcher().addDelegate(this),
        this._isMouseEnabled && e.getMouseDispatcher().addMouseDelegate(this, this._mousePriority)
    },
    onExit: function() {
        var e = cc.Director.getInstance();
        this._isTouchEnabled && e.getTouchDispatcher().removeDelegate(this),
        this._isKeyboardEnabled && e.getKeyboardDispatcher().removeDelegate(this),
        this._isMouseEnabled && e.getMouseDispatcher().removeMouseDelegate(this),
        this._super()
    },
    ...
    onTouchBegan: function(e, t) {
        return cc.Assert(!1, "Layer#onTouchBegan override me"),
        !0
    },
...
cc.LayerColor = cc.Layer.extend({
    ...
    init: function(e, t, n) {
        ...
        e = e || new cc.Color4B(0, 0, 0, 255),
        t = t || r.width,
        n = n || r.height,
        this._blendFunc.src = cc.BLEND_SRC,
        this._blendFunc.dst = cc.BLEND_DST,
        this._color = new cc.Color3B(e.r, e.g, e.b),
        this._opacity = e.a;
        for (var i = 0; i < this._squareVertices.length; i++) this._squareVertices[i].x = 0,
        this._squareVertices[i].y = 0;
        return this.setContentSize(cc.size(t, n)),
        this._updateColor(),
        !0
    },
    setContentSize: function(e) {
        this._squareVertices[1].x = e.width,
        this._squareVertices[2].y = e.height,
        this._squareVertices[3].x = e.width,
        this._squareVertices[3].y = e.height,
        this._super(e)
    },
    ...
    _updateColor: function() {
        for (var e = 0; e < 4; e++) this._squareColors[e].r = this._color.r / 255,
        this._squareColors[e].g = this._color.g / 255,
        this._squareColors[e].b = this._color.b / 255,
        this._squareColors[e].a = this._opacity / 255
    },
    ...
    draw: function(e) {
        ...
        t.fillStyle = "rgba(" + (0 | this._color.r) + "," + (0 | this._color.g) + "," + (0 | this._color.b) + "," + this.getOpacity() / 255 + ")",
        t.fillRect( - i.x, i.y, n, -r),
...
cc.LayerGradient = cc.LayerColor.extend({
    ...
    _updateColor: function() {
        if (cc.renderContextType === cc.CANVAS) {
            ...
            r = e - n.x,
            i = t - n.y;
            this._gradientStartPoint = cc.p(e * -this._alongVector.x + r, t * this._alongVector.y - i),
            this._gradientEndPoint = cc.p(e * this._alongVector.x + r, t * -this._alongVector.y - i)
        } else {
            this._super();
            ...
            this._squareColors[0].r = c.r + (l.r - c.r) * ((o + u.x + u.y) / (2 * o)),
            this._squareColors[0].g = c.g + (l.g - c.g) * ((o + u.x + u.y) / (2 * o)),
            this._squareColors[0].b = c.b + (l.b - c.b) * ((o + u.x + u.y) / (2 * o)),
            this._squareColors[0].a = c.a + (l.a - c.a) * ((o + u.x + u.y) / (2 * o)),
            this._squareColors[1].r = c.r + (l.r - c.r) * ((o - u.x + u.y) / (2 * o)),
            this._squareColors[1].g = c.g + (l.g - c.g) * ((o - u.x + u.y) / (2 * o)),
            this._squareColors[1].b = c.b + (l.b - c.b) * ((o - u.x + u.y) / (2 * o)),
            this._squareColors[1].a = c.a + (l.a - c.a) * ((o - u.x + u.y) / (2 * o)),
            this._squareColors[2].r = c.r + (l.r - c.r) * ((o + u.x - u.y) / (2 * o)),
            this._squareColors[2].g = c.g + (l.g - c.g) * ((o + u.x - u.y) / (2 * o)),
            this._squareColors[2].b = c.b + (l.b - c.b) * ((o + u.x - u.y) / (2 * o)),
            this._squareColors[2].a = c.a + (l.a - c.a) * ((o + u.x - u.y) / (2 * o)),
            this._squareColors[3].r = c.r + (l.r - c.r) * ((o - u.x - u.y) / (2 * o)),
            this._squareColors[3].g = c.g + (l.g - c.g) * ((o - u.x - u.y) / (2 * o)),
            this._squareColors[3].b = c.b + (l.b - c.b) * ((o - u.x - u.y) / (2 * o)),
            this._squareColors[3].a = c.a + (l.a - c.a) * ((o - u.x - u.y) / (2 * o))
        }
    },
    draw: function(e) {
        var t = e || cc.renderContext;
        if (cc.renderContextType == cc.CANVAS) {
            ...
            s.addColorStop(0, "rgba(" + Math.round(this._color.r) + "," + Math.round(this._color.g) + "," + Math.round(this._color.b) + "," + (this._startOpacity / 255).toFixed(4) + ")"),
            s.addColorStop(1, "rgba(" + Math.round(this._endColor.r) + "," + Math.round(this._endColor.g) + "," + Math.round(this._endColor.b) + "," + (this._endOpacity / 255).toFixed(4) + ")"),
            t.fillStyle = s,
            t.fillRect( - i.x, i.y, n, -r),
            this._rotation != 0 && t.rotate(this._rotationRadians),
            t.restore()
        }
    }
}),
...
cc.LayerMultiplex = cc.Layer.extend({
    ...
    switchTo: function(e) {
        cc.Assert(e < this._layers.length, "Invalid index in MultiplexLayer switchTo message"),
        this.removeChild(this._layers[this._enabledLayer], !0),
        this._enabledLayer = e,
        this.addChild(this._layers[e])
    },
    switchToAndReleaseMe: function(e) {
        cc.Assert(e < this._layers.count(), "Invalid index in MultiplexLayer switchTo message"),
        this.removeChild(this._layers[this._enabledLayer], !0),
...
cc.LazyLayer = cc.Node.extend({
    ...
    visit: function() {
        ...
        e.save(),
        e.clearRect(0, 0, this._layerCanvas.width, -this._layerCanvas.height);
...
cc.TransitionScene = cc.Scene.extend({
    ...
    _setNewScene: function(e) {
        ...
        t.replaceScene(this._inScene),
        t.getTouchDispatcher().setDispatchEvents(!0),
    ...
    initWithDuration: function(e, t) {
        return cc.Assert(t != null, "CCTransitionScene.initWithDuration() Argument scene must be non-nil"),
        this.init() ? (this._duration = e, this.setAnchorPoint(cc.p(0, 0)), this.setPosition(cc.p(0, 0)), this._inScene = t, this._outScene = cc.Director.getInstance().getRunningScene(), this._outScene || (this._outScene = cc.Scene.create(), this._outScene.init()), cc.Assert(this._inScene != this._outScene, "CCTransitionScene.initWithDuration() Incoming scene must be different from the outgoing scene"), cc.Director.getInstance().getTouchDispatcher().setDispatchEvents(!1), this._sceneOrder(), !0) : !1
    },
    finish: function() {
...
cc.TransitionSceneOriented = cc.TransitionScene.extend({
    _orientation: 0,
    initWithDuration: function(e, t, n) {
        return this._super(e, t) && (this._orientation = n),
        !0
    }
}),
...
cc.TransitionRotoZoom = cc.TransitionScene.extend({
    ...
    onEnter: function() {
        ...
        this._outScene.setScale(1),
        this._inScene.setAnchorPoint(cc.p(.5, .5)),
...
cc.TransitionJumpZoom = cc.TransitionScene.extend({
    onEnter: function() {
        ...
        this._outScene.runAction(i),
        this._inScene.runAction(cc.Sequence.create(o, s, cc.CallFunc.create(this.finish, this)))
    }
}),
...
cc.TransitionSlideInL = cc.TransitionScene.extend({
    ...
    onEnter: function() {
        ...
        this._inScene.runAction(n),
        this._outScene.runAction(r)
    },
    initScenes: function() {
        var e = cc.Director.getInstance().getWinSize();
...
cc.TransitionShrinkGrow = cc.TransitionScene.extend({
    onEnter: function() {
        ...
        this._inScene.setScale(.001),
        this._outScene.setScale(1),
        this._inScene.setAnchorPoint(cc.p(2 / 3, .5)),
        this._outScene.setAnchorPoint(cc.p(1 / 3, .5));
...
cc.TransitionFlipX = cc.TransitionSceneOriented.extend({
    onEnter: function() {
        ...
        var n, r, i, s;
        this._orientation == cc.TRANSITION_ORIENTATION_RIGHT_OVER ? (n = 90, r = 270, i = 90, s = 0) : (n = -90, r = 90, i = -90, s = 0),
        e = cc.Sequence.create(cc.DelayTime.create(this._duration / 2), cc.Show.create(), cc.OrbitCamera.create(this._duration / 2, 1, 0, r, n, 0, 0), cc.CallFunc.create(this.finish, this)),
        t = cc.Sequence.create(cc.OrbitCamera.create(this._duration / 2, 1, 0, s, i, 0, 0), cc.Hide.create(), cc.DelayTime.create(this._duration / 2)),
...
cc.TransitionFlipY = cc.TransitionSceneOriented.extend({
    onEnter: function() {
        ...
        this._inScene.setVisible(!1);
        var n, r, i, s;
        this._orientation == cc.TRANSITION_ORIENTATION_UP_OVER ? (n = 90, r = 270, i = 90, s = 0) : (n = -90, r = 90, i = -90, s = 0),
        e = cc.Sequence.create(cc.DelayTime.create(this._duration / 2), cc.Show.create(), cc.OrbitCamera.create(this._duration / 2, 1, 0, r, n, 90, 0), cc.CallFunc.create(this.finish, this)),
        t = cc.Sequence.create(cc.OrbitCamera.create(this._duration / 2, 1, 0, s, i, 90, 0), cc.Hide.create(), cc.DelayTime.create(this._duration / 2)),
        this._inScene.runAction(e),
        this._outScene.runAction(t)
    }
}),
...
cc.TransitionFlipAngular = cc.TransitionSceneOriented.extend({
    onEnter: function() {
        ...
        var n, r, i, s;
        this._orientation == cc.TRANSITION_ORIENTATION_RIGHT_OVER ? (n = 90, r = 270, i = 90, s = 0) : (n = -90, r = 90, i = -90, s = 0),
        e = cc.Sequence.create(cc.DelayTime.create(this._duration / 2), cc.Show.create(), cc.OrbitCamera.create(this._duration / 2, 1, 0, r, n, -45, 0), cc.CallFunc.create(this.finish, this)),
        t = cc.Sequence.create(cc.OrbitCamera.create(this._duration / 2, 1, 0, s, i, 45, 0), cc.Hide.create(), cc.DelayTime.create(this._duration / 2)),
        this._inScene.runAction(e),
        this._outScene.runAction(t)
    }
}),
...
cc.TransitionZoomFlipX = cc.TransitionSceneOriented.extend({
    onEnter: function() {
        ...
        var n, r, i, s;
        this._orientation == cc.TRANSITION_ORIENTATION_RIGHT_OVER ? (n = 90, r = 270, i = 90, s = 0) : (n = -90, r = 90, i = -90, s = 0),
        e = cc.Sequence.create(cc.DelayTime.create(this._duration / 2), cc.Spawn.create(cc.OrbitCamera.create(this._duration / 2, 1, 0, r, n, 0, 0), cc.ScaleTo.create(this._duration / 2, 1), cc.Show.create()), cc.CallFunc.create(this.finish, this)),
        t = cc.Sequence.create(cc.Spawn.create(cc.OrbitCamera.create(this._duration / 2, 1, 0, s, i, 0, 0), cc.ScaleTo.create(this._duration / 2, .5)), cc.Hide.create(), cc.DelayTime.create(this._duration / 2)),
        this._inScene.setScale(.5),
        this._inScene.runAction(e),
        this._outScene.runAction(t)
    }
...
cc.TransitionZoomFlipY = cc.TransitionSceneOriented.extend({
    onEnter: function() {
        ...
        var n, r, i, s;
        this._orientation == cc.TRANSITION_ORIENTATION_UP_OVER ? (n = 90, r = 270, i = 90, s = 0) : (n = -90, r = 90, i = -90, s = 0),
        e = cc.Sequence.create(cc.DelayTime.create(this._duration / 2), cc.Spawn.create(cc.OrbitCamera.create(this._duration / 2, 1, 0, r, n, 90, 0), cc.ScaleTo.create(this._duration / 2, 1), cc.Show.create()), cc.CallFunc.create(this.finish, this)),
        t = cc.Sequence.create(cc.Spawn.create(cc.OrbitCamera.create(this._duration / 2, 1, 0, s, i, 90, 0), cc.ScaleTo.create(this._duration / 2, .5)), cc.Hide.create(), cc.DelayTime.create(this._duration / 2)),
        this._inScene.setScale(.5),
        this._inScene.runAction(e),
        this._outScene.runAction(t)
    }
...
cc.TransitionZoomFlipAngular = cc.TransitionSceneOriented.extend({
    onEnter: function() {
        ...
        var n, r, i, s;
        this._orientation == cc.TRANSITION_ORIENTATION_RIGHT_OVER ? (n = 90, r = 270, i = 90, s = 0) : (n = -90, r = 90, i = -90, s = 0),
        e = cc.Sequence.create(cc.DelayTime.create(this._duration / 2), cc.Spawn.create(cc.OrbitCamera.create(this._duration / 2, 1, 0, r, n, -45, 0), cc.ScaleTo.create(this._duration / 2, 1), cc.Show.create()), cc.Show.create(), cc.CallFunc.create(this.finish, this)),
        t = cc.Sequence.create(cc.Spawn.create(cc.OrbitCamera.create(this._duration / 2, 1, 0, s, i, 45, 0), cc.ScaleTo.create(this._duration / 2, .5)), cc.Hide.create(), cc.DelayTime.create(this._duration / 2)),
        this._inScene.setScale(.5),
        this._inScene.runAction(e),
        this._outScene.runAction(t)
    }
...
cc.TransitionFade = cc.TransitionScene.extend({
    ...
    initWithDuration: function(e, t, n) {
        ...
        return this._super(e, t) && (this._color.r = n.r, this._color.g = n.g, this._color.b = n.b, this._color.a = 0),
        !0
    }
}),
...
cc.TransitionCrossFade = cc.TransitionScene.extend({
    onEnter: function() {
        ...
        if (null == r) return;
        r.getSprite().setAnchorPoint(cc.p(.5, .5)),
        r.setPosition(cc.p(t.width / 2, t.height / 2)),
        r.setAnchorPoint(cc.p(.5, .5)),
        r.begin(),
        this._inScene.visit(),
        r.end();
        var i = cc.RenderTexture.create(t.width, t.height);
        i.getSprite().setAnchorPoint(cc.p(.5, .5)),
        i.setPosition(cc.p(t.width / 2, t.height / 2)),
        i.setAnchorPoint(cc.p(.5, .5)),
        i.begin(),
        this._outScene.visit(),
        i.end(),
        r.getSprite().setBlendFunc(gl.ONE, gl.ONE),
        i.getSprite().setBlendFunc(gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA),
        n.addChild(r),
        n.addChild(i),
        r.getSprite().setOpacity(255),
        i.getSprite().setOpacity(255);
        ...
        i.getSprite().runAction(s),
        this.addChild(n, 2, cc.SCENE_FADE)
    },
    onExit: function() {
        this.removeChildByTag(cc.SCENE_FADE, !1),
        this._super()
...
cc.generateTextureCacheForColor = function(e) {
    ...
    for (var f = 0; f < 3; f++) {
        ...
        p = h.data;
        for (var d = 0; d < a.length; d += 4) p[d] = f === 0 ? a[d] : 0,
        p[d + 1] = f === 1 ? a[d + 1] : 0,
        p[d + 2] = f === 2 ? a[d + 2] : 0,
        p[d + 3] = a[d + 3];
...
cc.generateTintImage2 = function(e, t, n) {
    ...
    s = i.getContext("2d");
    return i.width != n.size.width && (i.width = n.size.width),
    i.height != n.size.height && (i.height = n.size.height),
    s.save(),
    s.drawImage(e, n.origin.x, n.origin.y, n.size.width, n.size.height, 0, 0, n.size.width, n.size.height),
    s.globalCompositeOperation = "source-in",
    s.globalAlpha = r.a / 255,
    s.fillStyle = "rgb(" + r.r + "," + r.g + "," + r.b + ")",
    s.fillRect(0, 0, n.size.width, n.size.height),
    s.restore(),
    i
},
cc.generateTintImage = function(e, t, n, r, i) {
    ...
    o.width = r.size.width,
    o.height = r.size.height;
    var u = o.getContext("2d");
    return u.globalCompositeOperation = "lighter",
    s.r > 0 && (u.globalAlpha = s.r / 255, u.drawImage(t[0], r.origin.x, r.origin.y, r.size.width, r.size.height, 0, 0, r.size.width, r.size.height)),
    s.g > 0 && (u.globalAlpha = s.g / 255, u.drawImage(t[1], r.origin.x, r.origin.y, r.size.width, r.size.height, 0, 0, r.size.width, r.size.height)),
    s.b > 0 && (u.globalAlpha = s.b / 255, u.drawImage(t[2], r.origin.x, r.origin.y, r.size.width, r.size.height, 0, 0, r.size.width, r.size.height)),
    o
},
cc.cutRotateImageToCanvas = function(e, t) {
    ...
    n.width = t.size.width,
    n.height = t.size.height;
    var r = n.getContext("2d");
    return r.translate(n.width / 2, n.height / 2),
    r.rotate( - 1.5707963267948966),
    r.drawImage(e, t.origin.x, t.origin.y, t.size.height, t.size.width, -t.size.height / 2, -t.size.width / 2, t.size.height, t.size.width),
    n
},
...
cc.Sprite = cc.Node.extend({
    ...
    initWithTexture: function(e, t, n) {
        ...
        this._quad.bl.colors = i,
        this._quad.br.colors = i,
        this._quad.tl.colors = i,
        this._quad.tr.colors = i;
        if (!t) {
            t = cc.rect(0, 0, 0, 0);
        ...
        return cc.renderContextType == cc.CANVAS && (this._originalTexture = e),
        this.setTexture(e),
        this.setTextureRect(t, n, t.size),
    ...
    initWithFile: function(e, t) {
        ...
        if (!r) {
            ...
            function() {
                t || (t = cc.rect(0, 0, i.width, i.height)),
                n.initWithTexture(i, t),
                cc.TextureCache.getInstance().cacheImage(e, i),
                n._visible = !0
            }),
    ...
    setTextureRect: function(e, t, n) {
        ...
        this._offsetPosition.x = r.x + (this._contentSize.width - this._rect.size.width) / 2,
        this._offsetPosition.y = r.y + (this._contentSize.height - this._rect.size.height) / 2;
        if (this._batchNode) this._dirty = !0;
            ...
            this._quad.bl.vertices = cc.vertex3(i, s, 0),
            this._quad.br.vertices = cc.vertex3(o, s, 0),
            this._quad.tl.vertices = cc.vertex3(i, u, 0),
            this._quad.tr.vertices = cc.vertex3(o, u, 0)
        }
    },
    ...
    updateTransform: function() {
        ...
        if (this.isDirty()) {
            if (!this._visible || this._parent && this._parent != this._batchNode && this._parent._shouldBeHidden) this._quad.br.vertices = this._quad.tl.vertices = this._quad.tr.vertices = this._quad.bl.vertices = cc.vertex3(0, 0, 0),
            this._shouldBeHidden = !0;
            else {
                this._shouldBeHidden = !1,
                !this._parent || this._parent == this._batchNode ? this._transformToBatch = this.nodeToParentTransform() : (cc.Assert(this._parent instanceof cc.Sprite, "Logic error in CCSprite. Parent must be a CCSprite"), this._transformToBatch = cc.AffineTransformConcat(this.nodeToParentTransform(), this._parent._transformToBatch));
                ...
                g = t * u - i * l + s,
                y = t * a + i * f + o;
                this._quad.bl.vertices = cc.vertex3(cc.RENDER_IN_SUBPIXEL(c), cc.RENDER_IN_SUBPIXEL(h), this._vertexZ),
                this._quad.br.vertices = cc.vertex3(cc.RENDER_IN_SUBPIXEL(p), cc.RENDER_IN_SUBPIXEL(d), this._vertexZ),
                this._quad.tl.vertices = cc.vertex3(cc.RENDER_IN_SUBPIXEL(g), cc.RENDER_IN_SUBPIXEL(y), this._vertexZ),
                this._quad.tr.vertices = cc.vertex3(cc.RENDER_IN_SUBPIXEL(v), cc.RENDER_IN_SUBPIXEL(m), this._vertexZ)
            }
    ...
    _getTransformValues: function(e) {
        return e.pos = this._position,
        e.scale.x = this._scaleX,
        e.scale.y = this._scaleY,
        e.rotation = this._rotation,
        e.skew.x = this._skewX,
        e.skew.y = this._skewY,
        e.ap = this._anchorPointInPoints,
    ...
    draw: function(e) {
        var t = e || cc.renderContext;
        this._isLighterMode && (t.globalCompositeOperation = "lighter"),
        t.globalAlpha = this._opacity / 255;
        var n = 0,
        r = 0;
        this._flipX && (n = 0 | this._contentSize.width / 2 - this._anchorPointInPoints.x, t.translate(n, 0), t.scale( - 1, 1)),
        this._flipY && (r = -(0 | this._contentSize.height / 2 - this._anchorPointInPoints.y), t.translate(0, r), t.scale(1, -1));
    ...
    sortAllChildren: function() {
        if (this._reorderChildDirty) {
            ...
            for (var n = 1; n < this._children.length; n++) {
                t = this._children[n],
                e = n - 1;
                while (e >= 0 && (t.getZOrder() < this._children[e].getZOrder() || t.getZOrder() == this._children[e].getZOrder() && t.getOrderOfArrival() < this._children[e].getOrderOfArrival())) this._children[e + 1] = this._children[e],
                e -= 1;
    ...
    reorderChild: function(e, t) {
        cc.Assert(e != null, "child is null"),
        cc.Assert(this._children.indexOf(e) > -1, "this child is not in children list");
        if (t == e.getZOrder()) return;
        this._batchNode && this._reorderChildDirty && (this._setReorderChildDirtyRecursively(), this._batchNode.reorderBatch(!0)),
        this._super(e, t)
    },
    removeChild: function(e, t) {
    ...
    setPosition: function(e) {
        arguments.length >= 2 ? cc.Node.prototype.setPosition.call(this, e, arguments[1]) : cc.Node.prototype.setPosition.call(this, e),
    ...
    setAnchorPoint: function(e) {
        cc.Node.prototype.setAnchorPoint.call(this, e),
        this.SET_DIRTY_RECURSIVELY()
    },
    ...
    setColor: function(e) {
        ...
        this._color = this._colorUnmodified = new cc.Color3B(e.r, e.g, e.b),
    ...
    setDisplayFrame: function(e) {
        this.setNodeDirty(),
        this._unflippedOffsetPositionFromCenter = e.getOffset();
        var t = e.getTexture();
        ...
        (this._color.r !== 255 || this._color.g !== 255 || this._color.b !== 255) && this._changeTextureColor()
    },
    setDisplayFrameWithAnimationName: function(e, t) {
        ...
        var r = n.getFrames()[t];
        cc.Assert(r, "cc.Sprite#setDisplayFrame. Invalid frame"),
        this.setDisplayFrame(r.getSpriteFrame())
    },
    ...
    setBatchNode: function(e) {
        ...
        if (!this._batchNode) {
            ...
            this._quad.bl.vertices = cc.vertex3(t, n, 0),
            this._quad.br.vertices = cc.vertex3(r, n, 0),
            this._quad.tl.vertices = cc.vertex3(t, i, 0),
            this._quad.tr.vertices = cc.vertex3(r, i, 0)
        } else this._transformToBatch = cc.AffineTransformIdentity(),
    ...
    _setReorderChildDirtyRecursively: function() {
        if (!this._reorderChildDirty) {
            ...
            var e = this._parent;
            while (e && e != this._batchNode) e._setReorderChildDirtyRecursively(),
            e = e.getParent()
        }
    },
    setTexture: function(e) {
        ...
        if (cc.renderContextType != cc.CANVAS) cc.Assert(!this._batchNode, "cc.Sprite: Batched sprites should use the same texture as the batchnode"),
        !this._batchNode && this._texture != e && (this._texture = e, this._updateBlendFunc());
...
cc.Sprite.createWithSpriteFrameName = function(e) {
    var t = null;
    if (typeof e != "string") return cc.log("Invalid argument. Expecting string."),
    null;
    t = cc.SpriteFrameCache.getInstance().getSpriteFrame(e);
    if (!t) return cc.log("Invalid spriteFrameName: " + e),
    null;
    var n = new cc.Sprite();
...
cc.AnimationFrame = cc.Class.extend({
    ...
    copy: function(e) {
        ...
        return t.initWithSpriteFrame(this._spriteFrame, this._delayPerUnit, this._userInfo),
        t
    },
    initWithSpriteFrame: function(e, t, n) {
        return this.setSpriteFrame(e),
        this.setDelayUnits(t),
        this.setUserInfo(n),
        !0
    },
...
cc.Animation = cc.Class.extend({
    ...
    initWithAnimationFrames: function(e, t, n) {
        ...
        for (var r = 0; r < e.length; r++) {
            var i = e[r];
            this._frames.push(i),
            this._totalDelayUnits += i.getDelayUnits()
        }
        return ! 0
    },
    copyWithZone: function(e) {
        var t = new cc.Animation();
        return t.initWithAnimationFrames(this._frames, this._delayPerUnit, this._loops),
    ...
    initWithSpriteFrames: function(e, t) {
        ...
        if (e) for (var r = 0; r < e.length; r++) {
            ...
            s.initWithSpriteFrame(i, 1, null),
            this._frames.push(s),
            this._totalDelayUnits++
        }
        return ! 0
...
cc.Animation.create = function(e, t, n) {
    var r = arguments.length,
    i = new cc.Animation();
    return r == 0 ? i.initWithSpriteFrames(null, 0) : r == 2 ? (t = t || 0, i.initWithSpriteFrames(e, t)) : r == 3 && i.initWithAnimationFrames(e, t, n),
    i
},
...
cc.AnimationCache = cc.Class.extend({
    ...
    addAnimations: function(e) {
        ...
        cc.Assert(n, "cc.AnimationCache: File could not be found"),
        this.addAnimationsWithDictionary(n)
    },
    _parseVersion1: function(e) {
        ...
        for (var n in e) {
            ...
            for (var a = 0; a < i.length; a++) {
                ...
                l.initWithSpriteFrame(f, 1, null),
                u.push(l)
            }
            if (u.length === 0) {
            ...
            u.length != i.length && cc.log("cocos2d: cc.AnimationCache: An animation in your dictionary refers to a frame which is not in the cc.SpriteFrameCache. Some or all of the frames for the animation '" + n + "' may be missing."),
            o = cc.Animation.createWithAnimationFrames(u, s, 1),
    ...
    _parseVersion2: function(e) {
        ...
        for (var n in e) {
            ...
            for (var f = 0; f < u.length; f++) {
                ...
                v.initWithSpriteFrame(h, p, d),
                a.push(v)
            }
            var m = parseFloat(r.delayPerUnit) || 0,
            g = new cc.Animation();
            g.initWithAnimationFrames(a, m, s),
            g.setRestoreOriginalFrame(o),
            cc.AnimationCache.getInstance().addAnimation(g, n)
        }
    },
    init: function() {
...
cc.AnimationCache.getInstance = function() {
    return cc.s_sharedAnimationCache === null && (cc.s_sharedAnimationCache = new cc.AnimationCache(), cc.s_sharedAnimationCache.init()),
...
cc.SpriteFrame = cc.Class.extend({
    ...
    initWithTexture: function(e, t, n, r, i) {
        ...
        case 5:
            ...
            this._offsetInPixels = r,
            this._offset = cc.POINT_PIXELS_TO_POINTS(this._offsetInPixels),
            this._originalSizeInPixels = i,
    ...
    initWithTextureFilename: function(e, t, n, r, i) {
        ...
        this._rotated = n || !1,
        this._offsetInPixels = r,
        this._offset = cc.POINT_PIXELS_TO_POINTS(r),
        this._originalSizeInPixels = i,
        this._originalSize = cc.SIZE_PIXELS_TO_POINTS(i),
        !0
    }
}),
...
cc.SpriteFrame._frameWithTextureForCanvas = function(e, t, n, r, i) {
    ...
    s._offsetInPixels = r,
    s._offset = cc.POINT_PIXELS_TO_POINTS(s._offsetInPixels),
    s._originalSizeInPixels = i,
    s._originalSize = cc.SIZE_PIXELS_TO_POINTS(s._originalSizeInPixels),
    s._rotated = n,
    s
};
cc.SpriteFrameCache = cc.Class.extend({
    ...
    _addSpriteFramesWithDictionary: function(e, t) {
        ...
        r = e.frames,
        i = 0;
        n != null && (i = parseInt(this._valueForKey("format", n))),
        cc.Assert(i >= 0 && i <= 3, "format is not supported for cc.SpriteFrameCache addSpriteFramesWithDictionary:textureFilename:");
        for (var s in r) {
            var o = r[s];
            if (o) {
                ...
                if (i == 0) {
                    ...
                    v = parseInt(this._valueForKey("originalHeight", o)); (!d || !v) && cc.log("cocos2d: WARNING: originalWidth/Height not found on the cc.SpriteFrame. AnchorPoint won't work as expected. Regenrate the .plist"),
                    d = Math.abs(d),
                    v = Math.abs(v),
                    u = new cc.SpriteFrame(),
                    u.initWithTexture(t, cc.rect(a, f, l, c), !1, cc.p(h, p), cc.size(d, v))
                } else if (i == 1 || i == 2) {
                    ...
                    u = new cc.SpriteFrame(),
                    u.initWithTexture(t, m, g, y, b)
                } else if (i == 3) {
                    var w, E, S, x, T;
                    w = cc.SizeFromString(this._valueForKey("spriteSize", o)),
                    E = cc.PointFromString(this._valueForKey("spriteOffset", o)),
                    S = cc.SizeFromString(this._valueForKey("spriteSourceSize", o)),
                    x = cc.RectFromString(this._valueForKey("textureRect", o)),
                    T = this._valueForKey("textureRotated", o) == "true";
                    var N = o.aliases,
                    C = s.toString();
                    for (var k in N) this._spriteFramesAliases.hasOwnProperty(N[k]) && cc.log("cocos2d: WARNING: an alias with name " + k + " already exists"),
                    this._spriteFramesAliases[N[k]] = C;
                    u = new cc.SpriteFrame(),
                    o.hasOwnProperty("spriteSize") ? u.initWithTexture(t, cc.rect(x.origin.x, x.origin.y, w.width, w.height), T, E, S) : u.initWithTexture(t, w, T, E, S)
                }
                if (u.isRotated()) {
                    var L = cc.cutRotateImageToCanvas(u.getTexture(), u.getRect()),
                    A = u.getRect();
                    u.setRect(cc.rect(0, 0, A.size.width, A.size.height)),
                    u.setTexture(L)
                }
    ...
    removeSpriteFrameByName: function(e) {
        if (!e) return;
        this._spriteFramesAliases.hasOwnProperty(e) && delete this._spriteFramesAliases[e],
        this._spriteFrames.hasOwnProperty(e) && delete this._spriteFrames[e],
        this._loadedFileNames = {}
    },
    removeSpriteFramesFromFile: function(e) {
        var t = cc.FileUtils.getInstance().fullPathFromRelativePath(e),
        n = cc.FileUtils.getInstance().dictionaryWithContentsOfFileThreadSafe(t);
        this._removeSpriteFramesFromDictionary(n),
...
cc.SpriteBatchNode = cc.Node.extend({
    ...
    setContentSize: function(e) {
        if (!e) return;
        this._super(e),
        this._renderTexture.setContentSize(e)
    },
    _updateBlendFunc: function() {
    ...
    _updateAtlasIndex: function(e, t) {
        ...
        r && (n = r.length);
        var i = 0;
        if (n == 0) i = e.getAtlasIndex(),
        e.setAtlasIndex(t),
        e.setOrderOfArrival(0),
        i != t && this._swap(i, t),
        t++;
        else {
            var s = !0;
            ...
            for (var o = 0; o < r.length; o++) {
                var u = r[o];
                s && u.getZOrder() >= 0 && (i = e.getAtlasIndex(), e.setAtlasIndex(t), e.setOrderOfArrival(0), i != t && this._swap(i, t), t++, s = !1),
                this._updateAtlasIndex(u, t)
            }
    ...
    _swap: function(e, t) {
        if (this._descendants.length >= 2 && t < this._descendants.length) {
            ...
            i = n[e];
            this._descendants[t].setAtlasIndex(e),
            this._descendants[e] = this._descendants[t],
            n[e] = n[t],
            this._descendants[t] = r,
            n[t] = i
        }
    },
    addQuadFromSprite: function(e, t) {
        cc.Assert(e != null, "SpriteBatchNode.addQuadFromSprite():Argument must be non-nil"),
        cc.Assert(e instanceof cc.Sprite, "cc.SpriteBatchNode only supports cc.Sprites as children"),
        e.setBatchNode(this),
        e.setAtlasIndex(t),
        this._textureAtlas.insertQuad(e.getQuad(), t),
        e.setDirty(!0),
        e.updateTransform(),
        cc.renderContextType == cc.CANVAS && (this._children = cc.ArrayAppendObjectToIndex(this._children, e, t))
    },
    addSpriteWithoutQuad: function(e, t, n) {
        ...
        if (this._descendants && this._descendants.length > 0) {
            var i = null;
            for (var s = 0; s < this._descendants.length; s++) i = this._descendants[s],
            i && i.getAtlasIndex() >= t && ++r
        }
        return this._descendants = cc.ArrayAppendObjectToIndex(this._descendants, e, r),
        this.addChild(e, t, n),
        this.reorderBatch(!1),
        this
    },
    ...
    initWithTexture: function(e, t) {
        ...
        this._textureAtlas.initWithTexture(e, t),
        cc.renderContextType == cc.CANVAS && (this._originalTexture = e),
    ...
    init: function(e, t) {
        ...
        return n || (n = cc.TextureCache.getInstance().addImage(e)),
        this.initWithTexture(n, t)
    },
    increaseAtlasCapacity: function() {
        var e = (this._textureAtlas.getCapacity() + 1) * 4 / 3;
        cc.log("cocos2d: CCSpriteBatchNode: resizing TextureAtlas capacity from " + this._textureAtlas.getCapacity() + " to [" + e + "]."),
        this._textureAtlas.resizeCapacity(e) || (cc.log("cocos2d: WARNING: Not enough memory to resize the atlas"), cc.Assert(!1, "Not enough memory to resize the atla"))
    },
    ...
    insertChild: function(e, t) {
        ...
        this._textureAtlas.insertQuad(e.getQuad(), t),
        this._descendants = cc.ArrayAppendObjectToIndex(this._descendants, e, t);
        var n = t + 1;
    ...
    appendChild: function(e) {
        ...
        e.setDirty(!0),
        this._textureAtlas.getTotalQuads() == this._textureAtlas.getCapacity() && this.increaseAtlasCapacity(),
        cc.ArrayAppendObject(this._descendants, e);
    ...
    removeSpriteFromAtlas: function(e) {
        this._textureAtlas.removeQuadAtIndex(e.getAtlasIndex()),
        e.setBatchNode(null);
    ...
    rebuildIndexInOrder: function(e, t) {
        ...
        if (n && n.length > 0) for (r = 0; r < n.length; r++) i = n[r],
        i && i.getZOrder() >= 0 && (t = this.rebuildIndexInOrder(i, t));
        return t
    },
    ...
    visit: function(e) {
        if (cc.renderContextType == cc.CANVAS) {
            ...
            if (!this._visible) return;
            this._grid && this._grid.isActive() && (this._grid.beforeDraw(), this.transformAncestors()),
            this.sortAllChildren(),
            this.transform(),
            this.draw(),
    ...
    addChild: function(e, t, n) {
        ...
        case 2:
            ...
            break;
        case 3:
            cc.Assert(e != null, "SpriteBatchNode.addChild():child should not be null"),
            cc.Assert(e instanceof cc.Sprite, "cc.SpriteBatchNode only supports cc.Sprites as children"),
            cc.renderContextType != cc.CANVAS && cc.Assert(e.getTexture().getName() == this._textureAtlas.getTexture().getName(), "SpriteBatchNode.addChild():check cc.Sprite is using the same texture id"),
            this._super(e, t, n),
            this.appendChild(e);
            break;
        case 4:
    ...
    reorderChild: function(e, t) {
        cc.Assert(e != null, "SpriteBatchNode.addChild():the child should not be null"),
        cc.Assert(this._children.indexOf(e) > -1, "SpriteBatchNode.addChild():Child doesn't belong to Sprite");
        if (t == e.getZOrder()) return;
        this._super(e, t),
        this.setNodeDirty()
    },
    removeChild: function(e, t) {
        if (e == null) return;
        cc.Assert(this._children.indexOf(e) > -1, "SpriteBatchNode.addChild():sprite batch node should contain the child"),
        this.removeSpriteFromAtlas(e),
        this._super(e, t)
    },
    removeAllChildren: function(e) {
        var t;
    ...
    sortAllChildren: function() {
        if (this._reorderChildDirty) {
            ...
            for (e = 1; e < n; e++) {
                ...
                t = e - 1;
                while (t >= 0 && (r.getZOrder() < this._children[t].getZOrder() || r.getZOrder() == this._children[t].getZOrder() && r.getOrderOfArrival() < this._children[t].getOrderOfArrival())) this._children[t + 1] = this._children[t],
                t--;
...
cc.LabelTTF = cc.Sprite.extend({
    ...
    setDimensions: function(e) {
        ...
        this._string.length > 0 && this._updateTTF()
    },
    ...
    initWithString: function(e) {
        ...
        s,
        o;
        return cc.Assert(t != null, "cc.LabelTTF.initWithString() label is null"),
        e.length == 6 ? (n = e[1], r = e[2], i = e[3], s = e[4], o = e[5]) : e.length == 5 ? (n = e[1], r = e[2], i = e[3], s = e[4], o = cc.VERTICAL_TEXT_ALIGNMENT_TOP) : (n = e[1], r = e[2], i = cc.size(0, e[2]), s = cc.TEXT_ALIGNMENT_LEFT, o = cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM),
        this.init(!0) ? (this._dimensions = cc.size(i.width, i.height), this._fontName = n, this._hAlignment = s, this._vAlignment = o, this._fontSize = r * cc.CONTENT_SCALE_FACTOR(), this.setString(t), this._fontStyleStr = this._fontSize + "px '" + this._fontName + "'", this._updateTTF(), !0) : !1
    },
    draw: function(e) {
        if (cc.renderContextType == cc.CANVAS) {
            var t = e || cc.renderContext;
            this._flipX && t.scale( - 1, 1),
            this._flipY && t.scale(1, -1),
            t.fillStyle = this._colorStyleStr,
            t.font != this._fontStyleStr && (t.font = this._fontStyleStr);
            if ((this._contentSize.width > this._dimensions.width || this._string.indexOf("\n") > -1) && this._dimensions.width !== 0) t.textBaseline = cc.LabelTTF._textBaseline[this._vAlignment],
            t.textAlign = cc.LabelTTF._textAlign[this._hAlignment],
            this._wrapText(t, this._string, -this._dimensions.width * this._anchorPoint.x, this._dimensions.height * this._anchorPoint.y, this._dimensions.width, this._dimensions.height, this._fontSize * 1.2);
                ...
                t.textBaseline = cc.LabelTTF._textBaseline[this._vAlignment],
                t.textAlign = cc.LabelTTF._textAlign[this._hAlignment];
                var r = 0,
                i = 0;
                this._hAlignment == cc.TEXT_ALIGNMENT_RIGHT && (r = this._dimensions.width),
                this._hAlignment == cc.TEXT_ALIGNMENT_CENTER && (r = this._dimensions.width / 2),
                this._vAlignment == cc.VERTICAL_TEXT_ALIGNMENT_TOP && (i = -this._dimensions.height),
                this._vAlignment == cc.VERTICAL_TEXT_ALIGNMENT_CENTER && (i = -this._dimensions.height / 2),
                t.fillText(this._string, -this._dimensions.width * this._anchorPoint.x + r, this._dimensions.height * this._anchorPoint.y + i)
            }
            cc.INCREMENT_GL_DRAWS(1)
        }
    },
    _multiLineText: function(e) {
        ...
        i = [],
        s = 0;
        for (var o = 0; o < r; o++) i[o] = e.measureText(n[o]).width,
        i[o] > s && (s = i[o]);
        var u = cc.p(s / 2, r * t / 2);
        for (o = 0; o < r; o++) {
            var a = -i[o] / 2;
            this._hAlignment == cc.TEXT_ALIGNMENT_RIGHT && (a = u.x - s),
            this._hAlignment == cc.TEXT_ALIGNMENT_CENTER && (a = s - i[o]),
            e.fillText(n[o], a, o * t - u.y + t / 2)
        }
    },
    _wrapText: function(e, t, n, r, i, s, o) {
        ...
        a = 0,
        f = 0;
        this._hAlignment === cc.TEXT_ALIGNMENT_RIGHT && (a = i),
        this._hAlignment === cc.TEXT_ALIGNMENT_CENTER && (a = i / 2),
        this._vAlignment === cc.VERTICAL_TEXT_ALIGNMENT_TOP && (f = -s),
        this._vAlignment === cc.VERTICAL_TEXT_ALIGNMENT_BOTTOM && (f = -o * u),
        this._vAlignment === cc.VERTICAL_TEXT_ALIGNMENT_CENTER && (f = -s / 2 - o * u / 2);
        var l = t.split("\n");
        for (var c = 0; c < l.length; c++) {
            ...
            for (var v = 0; v < p.length; v++) {
                ...
                g >= i ? (e.fillText(d, n + a, r + f + h), r += o, d = p[v] + " ") : d = m,
                v == p.length - 1 && e.fillText(d, n + a, r + f + h)
            }
        }
    },
    _lineCount: function() {
        ...
        for (var i = 0; i < t.length; i++) {
            ...
            o >= this._dimensions.width ? (r++, n = t[i] + " ") : n = s,
            i == t.length - 1 && r++
        }
        return cc.renderContext.restore(),
        r
    },
    _updateTTF: function() {
        ...
        this.setContentSize(cc.size(t.width, this._fontSize)),
        cc.renderContext.font = e,
        this.setNodeDirty()
    }
}),
...
cc.Particle = function(e, t, n, r, i, s, o, u, a, f, l, c) {
    this.pos = e ? e: cc.PointZero(),
    this.startPos = t ? t: cc.PointZero(),
    this.color = n ? n: new cc.Color4F(0, 0, 0, 1),
    this.deltaColor = r ? r: new cc.Color4F(0, 0, 0, 1),
    this.size = i || 0,
    this.deltaSize = s || 0,
    this.rotation = o || 0,
    this.deltaRotation = u || 0,
    this.timeToLive = a || 0,
    this.atlasIndex = f || 0,
    this.modeA = l ? l: new cc.Particle.ModeA(),
    this.modeB = c ? c: new cc.Particle.ModeB(),
    this.isChangeColor = !1,
    this.drawPos = cc.p(0, 0)
},
cc.Particle.ModeA = function(e, t, n) {
    this.dir = e ? e: cc.PointZero(),
    this.radialAccel = t || 0,
    this.tangentialAccel = n || 0
},
cc.Particle.ModeB = function(e, t, n, r) {
    this.angle = e || 0,
    this.degreesPerSecond = t || 0,
    this.radius = n || 0,
    this.deltaRadius = r || 0
},
cc.ParticleSystem = cc.Node.extend({
    ...
    getGravity: function() {
        return cc.Assert(this._emitterMode == cc.PARTICLE_MODE_GRAVITY, "Particle Mode should be Gravity"),
        this.modeA.gravity
    },
    setGravity: function(e) {
        cc.Assert(this._emitterMode == cc.PARTICLE_MODE_GRAVITY, "Particle Mode should be Gravity"),
        this.modeA.gravity = e
    },
    getSpeed: function() {
        return cc.Assert(this._emitterMode == cc.PARTICLE_MODE_GRAVITY, "Particle Mode should be Gravity"),
        this.modeA.speed
    ...
    setTangentialAccelVar: function(e) {
        cc.Assert(this._emitterMode == cc.PARTICLE_MODE_GRAVITY, "Particle Mode should be Gravity"),
        this.modeA.tangentialAccelVar = e
    },
    ...
    setRadialAccelVar: function(e) {
        cc.Assert(this._emitterMode == cc.PARTICLE_MODE_GRAVITY, "Particle Mode should be Gravity"),
        this.modeA.radialAccelVar = e
    },
    getStartRadius: function() {
        return cc.Assert(this._emitterMode == cc.PARTICLE_MODE_RADIUS, "Particle Mode should be Radius"),
    ...
    setRotatePerSecondVar: function(e) {
        cc.Assert(this._emitterMode == cc.PARTICLE_MODE_RADIUS, "Particle Mode should be Radius"),
        this.modeB.rotatePerSecondVar = e
    },
    setScale: function(e, t) {
    ...
    setTotalParticles: function(e) {
        cc.Assert(e <= this._allocatedParticles, "Particle: resizing particle array only supported for quads"),
        this._totalParticles = e
    },
    _texture: null,
    getTexture: function() {
        return this._texture
    ...
    setBlendAdditive: function(e) {
        this._isBlendAdditive = e,
        e ? (this._blendFunc.src = gl.SRC_ALPHA, this._blendFunc.dst = gl.ONE) : (this._blendFunc.src = cc.BLEND_SRC, this._blendFunc.dst = cc.BLEND_DST)
    },
    ...
    initWithFile: function(e) {
        ...
        return cc.Assert(n != null, "Particles: file not found"),
        this.initWithDictionary(n)
    },
    ...
    initWithDictionary: function(e) {
        ...
        if (this.initWithTotalParticles(s)) {
            this._angle = parseFloat(this._valueForKey("angle", e)),
            this._angleVar = parseFloat(this._valueForKey("angleVariance", e)),
            this._duration = parseFloat(this._valueForKey("duration", e)),
            this._blendFunc.src = parseInt(this._valueForKey("blendFuncSource", e)),
            this._blendFunc.dst = parseInt(this._valueForKey("blendFuncDestination", e)),
            this._startColor.r = parseFloat(this._valueForKey("startColorRed", e)),
            this._startColor.g = parseFloat(this._valueForKey("startColorGreen", e)),
            this._startColor.b = parseFloat(this._valueForKey("startColorBlue", e)),
            this._startColor.a = parseFloat(this._valueForKey("startColorAlpha", e)),
            this._startColorVar.r = parseFloat(this._valueForKey("startColorVarianceRed", e)),
            this._startColorVar.g = parseFloat(this._valueForKey("startColorVarianceGreen", e)),
            this._startColorVar.b = parseFloat(this._valueForKey("startColorVarianceBlue", e)),
            this._startColorVar.a = parseFloat(this._valueForKey("startColorVarianceAlpha", e)),
            this._endColor.r = parseFloat(this._valueForKey("finishColorRed", e)),
            this._endColor.g = parseFloat(this._valueForKey("finishColorGreen", e)),
            this._endColor.b = parseFloat(this._valueForKey("finishColorBlue", e)),
            this._endColor.a = parseFloat(this._valueForKey("finishColorAlpha", e)),
            this._endColorVar.r = parseFloat(this._valueForKey("finishColorVarianceRed", e)),
            this._endColorVar.g = parseFloat(this._valueForKey("finishColorVarianceGreen", e)),
            this._endColorVar.b = parseFloat(this._valueForKey("finishColorVarianceBlue", e)),
            this._endColorVar.a = parseFloat(this._valueForKey("finishColorVarianceAlpha", e)),
            this._startSize = parseFloat(this._valueForKey("startParticleSize", e)),
            this._startSizeVar = parseFloat(this._valueForKey("startParticleSizeVariance", e)),
            this._endSize = parseFloat(this._valueForKey("finishParticleSize", e)),
            this._endSizeVar = parseFloat(this._valueForKey("finishParticleSizeVariance", e));
            var o = parseFloat(this._valueForKey("sourcePositionx", e)),
            u = parseFloat(this._valueForKey("sourcePositiony", e));
            this.setPosition(cc.p(o, u)),
            this._posVar.x = parseFloat(this._valueForKey("sourcePositionVariancex", e)),
            this._posVar.y = parseFloat(this._valueForKey("sourcePositionVariancey", e)),
            this._startSpin = parseFloat(this._valueForKey("rotationStart", e)),
            this._startSpinVar = parseFloat(this._valueForKey("rotationStartVariance", e)),
            this._endSpin = parseFloat(this._valueForKey("rotationEnd", e)),
            this._endSpinVar = parseFloat(this._valueForKey("rotationEndVariance", e)),
            this._emitterMode = parseInt(this._valueForKey("emitterType", e));
            if (this._emitterMode == cc.PARTICLE_MODE_GRAVITY) {
                this.modeA.gravity.x = parseFloat(this._valueForKey("gravityx", e)),
                this.modeA.gravity.y = parseFloat(this._valueForKey("gravityy", e)),
                this.modeA.speed = parseFloat(this._valueForKey("speed", e)),
                this.modeA.speedVar = parseFloat(this._valueForKey("speedVariance", e));
                var a = this._valueForKey("radialAcceleration", e);
                this.modeA.radialAccel = a ? parseFloat(a) : 0,
                a = this._valueForKey("radialAccelVariance", e),
                this.modeA.radialAccelVar = a ? parseFloat(a) : 0,
                a = this._valueForKey("tangentialAcceleration", e),
                this.modeA.tangentialAccel = a ? parseFloat(a) : 0,
                a = this._valueForKey("tangentialAccelVariance", e),
                this.modeA.tangentialAccelVar = a ? parseFloat(a) : 0
            } else {
                if (this._emitterMode != cc.PARTICLE_MODE_RADIUS) return cc.Assert(!1, "Invalid emitterType in config file"),
                !1;
                this.modeB.startRadius = parseFloat(this._valueForKey("maxRadius", e)),
                this.modeB.startRadiusVar = parseFloat(this._valueForKey("maxRadiusVariance", e)),
                this.modeB.endRadius = parseFloat(this._valueForKey("minRadius", e)),
                this.modeB.endRadiusVar = 0,
                this.modeB.rotatePerSecond = parseFloat(this._valueForKey("rotatePerSecond", e)),
                this.modeB.rotatePerSecondVar = parseFloat(this._valueForKey("rotatePerSecondVariance", e))
            }
            this._life = parseFloat(this._valueForKey("particleLifespan", e)),
            this._lifeVar = parseFloat(this._valueForKey("particleLifespanVariance", e)),
            ...
            if (!this._batchNode) {
                ...
                if (c) this._texture = c;
                    ...
                    if (h && h.length == 0) {
                        cc.Assert(h, "cc.ParticleSystem.initWithDictory:textureImageData is null"),
                        c = cc.TextureCache.getInstance().addImage(l);
                        if (!c) return ! 1;
                        this._texture = c
                    } else {
                        ...
                        if (!p) return ! 1;
                        var d = new Image();
                        d.src = "data:image/png;base64," + p,
                        this._texture = d,
                        cc.TextureCache.getInstance().cacheImage(l, d)
                    }
                }
    ...
    initWithTotalParticles: function(e) {
        ...
        this._particles = [],
        this._particlePool = [];
        if (!this._particles) return cc.log("Particle system: not enough memory"),
        !1;
    ...
    initParticle: function(e) {
        e.timeToLive = this._life + this._lifeVar * cc.RANDOM_MINUS1_1(),
        e.timeToLive = Math.max(0, e.timeToLive),
        e.pos.x = this._sourcePosition.x + this._posVar.x * cc.RANDOM_MINUS1_1(),
        e.pos.y = this._sourcePosition.y + this._posVar.y * cc.RANDOM_MINUS1_1();
        ...
        e.color = t,
        e.deltaColor.r = (n.r - t.r) / e.timeToLive,
        e.deltaColor.g = (n.g - t.g) / e.timeToLive,
        e.deltaColor.b = (n.b - t.b) / e.timeToLive,
        e.deltaColor.a = (n.a - t.a) / e.timeToLive;
        ...
        if (this._endSize == cc.PARTICLE_START_SIZE_EQUAL_TO_END_SIZE) e.deltaSize = 0;
            ...
            i = Math.max(0, i),
            e.deltaSize = (i - r) / e.timeToLive
        }
        var s = this._startSpin + this._startSpinVar * cc.RANDOM_MINUS1_1(),
        o = this._endSpin + this._endSpinVar * cc.RANDOM_MINUS1_1();
        e.rotation = s,
        e.deltaRotation = (o - s) / e.timeToLive,
        this._positionType == cc.PARTICLE_TYPE_FREE ? e.startPos = this.convertToWorldSpace(this._pointZeroForParticle) : this._positionType == cc.PARTICLE_TYPE_RELATIVE && (e.startPos = this._position);
        ...
        if (this._emitterMode == cc.PARTICLE_MODE_GRAVITY) {
            ...
            e.modeA.dir = cc.pMult(a, f),
            e.modeA.radialAccel = this.modeA.radialAccel + this.modeA.radialAccelVar * cc.RANDOM_MINUS1_1(),
            e.modeA.tangentialAccel = this.modeA.tangentialAccel + this.modeA.tangentialAccelVar * cc.RANDOM_MINUS1_1()
        } else {
            ...
            e.modeB.radius = l,
            this.modeB.endRadius == cc.PARTICLE_START_RADIUS_EQUAL_TO_END_RADIUS ? e.modeB.deltaRadius = 0 : e.modeB.deltaRadius = (c - l) / e.timeToLive,
            e.modeB.angle = u,
            e.modeB.degreesPerSecond = cc.DEGREES_TO_RADIANS(this.modeB.rotatePerSecond + this.modeB.rotatePerSecondVar * cc.RANDOM_MINUS1_1())
        }
    },
    stopSystem: function() {
        this._isActive = !1,
    ...
    update: function(e) {
        if (this._isActive && this._emissionRate) {
            ...
            while (this._particleCount < this._totalParticles && this._emitCounter > t) this.addParticle(),
            this._emitCounter -= t;
            this._elapsed += e,
            this._duration != -1 && this._duration < this._elapsed && this.stopSystem()
        }
        this._particleIdx = 0;
        var n;
        ...
        if (this._visible) {
            while (this._particleIdx < this._particleCount) {
                ...
                if (r.timeToLive > 0) {
                    if (this._emitterMode == cc.PARTICLE_MODE_GRAVITY) {
                        var i, s, o;
                        r.pos.x || r.pos.y ? s = cc.pNormalize(r.pos) : s = cc.PointZero(),
                        o = s,
                        s = cc.pMult(s, r.modeA.radialAccel);
                        var u = o.x;
                        o.x = -o.y,
                        o.y = u,
                        o = cc.pMult(o, r.modeA.tangentialAccel),
                        i = cc.pAdd(cc.pAdd(s, o), this.modeA.gravity),
                        i = cc.pMult(i, e),
                        r.modeA.dir = cc.pAdd(r.modeA.dir, i),
                        i = cc.pMult(r.modeA.dir, e),
                        r.pos = cc.pAdd(r.pos, i)
                    } else r.modeB.angle += r.modeB.degreesPerSecond * e,
                    r.modeB.radius += r.modeB.deltaRadius * e,
                    r.pos.x = -Math.cos(r.modeB.angle) * r.modeB.radius,
                    r.pos.y = -Math.sin(r.modeB.angle) * r.modeB.radius;
                    this._dontTint || (r.color.r += r.deltaColor.r * e, r.color.g += r.deltaColor.g * e, r.color.b += r.deltaColor.b * e, r.color.a += r.deltaColor.a * e, r.isChangeColor = !0),
                    r.size += r.deltaSize * e,
                    r.size = Math.max(0, r.size),
                    r.rotation += r.deltaRotation * e;
                    var a;
                    if (this._positionType == cc.PARTICLE_TYPE_FREE || this._positionType == cc.PARTICLE_TYPE_RELATIVE) {
                        var f = cc.pSub(n, r.startPos);
                        a = cc.pSub(r.pos, f)
                    } else a = r.pos;
                    this._batchNode && (a.x += this._position.x, a.y += this._position.y),
                    cc.renderContextType == cc.WEBGL ? this.updateQuadWithParticle(r, a) : r.drawPos = a,
                    ++this._particleIdx
                } else {
                    var l = r.atlasIndex;
                    cc.ArrayRemoveObject(this._particles, r),
                    this._particlePool.push(r),
                    this._batchNode && (this._batchNode.disableParticle(this._atlasIndex + l), this._particles[this._particleCount - 1].atlasIndex = l),
                    --this._particleCount;
    ...
    _updateBlendFunc: function() {
        ...
        if (this._texture && !(this._texture instanceof HTMLImageElement || this._texture instanceof HTMLCanvasElement)) {
            ...
            this._opacityModifyRGB = !1,
            this._texture && this._blendFunc.src == cc.BLEND_SRC && this._blendFunc.dst == cc.BLEND_DST && (e ? this._opacityModifyRGB = !0 : (this._blendFunc.src = gl.SRC_ALPHA, this._blendFunc.dst = gl.ONE_MINUS_SRC_ALPHA))
        }
    }
}),
function() {
    ...
    e.btoa || (e.btoa = function(e) {
        for (var r, i, s = 0,
        o = t,
        u = ""; e.charAt(s | 0) || (o = "=", s % 1); u += o.charAt(63 & r >> 8 - s % 1 * 8)) {
            i = e.charCodeAt(s += .75);
            if (i > 255) throw n;
            r = r << 8 | i
        }
    ...
    e.atob || (e.atob = function(e) {
        ...
        for (var r = 0,
        i, s, o = 0,
        u = ""; s = e.charAt(o++);~s && (i = r % 4 ? i * 64 + s: s, r++%4) ? u += String.fromCharCode(255 & i >> ( - 2 * r & 6)) : 0) s = t.indexOf(s);
        return u
    })
} (),
...
cc.ParticleSystem.ModeA = function(e, t, n, r, i, s, o) {
    this.gravity = e ? e: cc.PointZero(),
    this.speed = t || 0,
    this.speedVar = n || 0,
    this.tangentialAccel = r || 0,
    this.tangentialAccelVar = i || 0,
    this.radialAccel = s || 0,
    this.radialAccelVar = o || 0
},
cc.ParticleSystem.ModeB = function(e, t, n, r, i, s) {
    this.startRadius = e || 0,
    this.startRadiusVar = t || 0,
    this.endRadius = n || 0,
    this.endRadiusVar = r || 0,
    this.rotatePerSecond = i || 0,
...
cc.ParticleSystemQuad = cc.ParticleSystem.extend({
    ...
    setupIndices: function() {
        for (var e = 0; e < this._totalParticles; ++e) {
            var t = e * 6,
            n = e * 4;
            this._indices[t + 0] = n + 0,
            this._indices[t + 1] = n + 1,
            this._indices[t + 2] = n + 2,
            this._indices[t + 5] = n + 1,
            this._indices[t + 4] = n + 2,
            this._indices[t + 3] = n + 3
        }
    },
    ...
    setTexture: function(e, t) {
        ...
        var n = null;
        e instanceof HTMLImageElement || e instanceof HTMLCanvasElement ? n = cc.size(e.width, e.height) : n = e.getContentSize(),
        this.setTextureWithRect(e, cc.rect(0, 0, n.width, n.height))
    },
    updateQuadWithParticle: function(e, t) {
        var n = null;
        if (this._batchNode) {
        ...
        if (e.rotation) {
            ...
            n.tr.vertices.x = b,
            n.tr.vertices.y = w
        } else n.bl.vertices.x = t.x - s,
        n.bl.vertices.y = t.y - s,
        n.br.vertices.x = t.x + s,
        n.br.vertices.y = t.y - s,
        n.tl.vertices.x = t.x - s,
        n.tl.vertices.y = t.y + s,
        n.tr.vertices.x = t.x + s,
        n.tr.vertices.y = t.y + s
    },
    postStep: function() {
    ...
    draw: function(e) {
        ...
        var t = e || cc.renderContext;
        t.save(),
        this.isBlendAdditive() ? t.globalCompositeOperation = "lighter": t.globalCompositeOperation = "source-over";
        for (var n = 0; n < this._particleCount; n++) {
            ...
            if (this._drawMode == cc.PARTICLE_TEXTURE_MODE) {
                ...
                t.save(),
                t.globalAlpha = r.color.a,
                t.translate(0 | r.drawPos.x, -(0 | r.drawPos.y)),
                r.rotation && t.rotate(cc.DEGREES_TO_RADIANS(r.rotation)),
                t.drawImage(s, -i, -i, r.size, r.size),
                t.restore()
            } else t.save(),
            t.globalAlpha = r.color.a,
            t.translate(0 | r.drawPos.x, -(0 | r.drawPos.y)),
            this._shapeType == cc.PARTICLE_STAR_SHAPE ? (r.rotation && t.rotate(cc.DEGREES_TO_RADIANS(r.rotation)), cc.drawingUtil.drawStar(t, i, r.color)) : cc.drawingUtil.drawColorBall(t, i, r.color),
            t.restore()
        }
        t.restore(),
        cc.INCREMENT_GL_DRAWS(1)
    ...
    _drawForWebGL: function(e) {
        ...
        if (cc.TEXTURE_ATLAS_USE_VAO) glBindVertexArray(this._VAOname),
        cc.REBIND_INDICES_BUFFER && glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, this._buffersVBO[1]),
        glDrawElements(GL_TRIANGLES, this._particleIdx * 6, GL_UNSIGNED_SHORT, 0),
        cc.REBIND_INDICES_BUFFER && glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0),
        glBindVertexArray(0);
        else {
            var t = sizeof(m_pQuads[0].bl);
            ccGLEnableVertexAttribs(kCCVertexAttribFlag_PosColorTex),
            glBindBuffer(GL_ARRAY_BUFFER, this._buffersVBO[0]),
            glVertexAttribPointer(kCCVertexAttrib_Position, 3, GL_FLOAT, GL_FALSE, t, offsetof(ccV3F_C4B_T2F, vertices)),
            glVertexAttribPointer(kCCVertexAttrib_Color, 4, GL_UNSIGNED_BYTE, GL_TRUE, t, offsetof(ccV3F_C4B_T2F, colors)),
            glVertexAttribPointer(kCCVertexAttrib_TexCoords, 2, GL_FLOAT, GL_FALSE, t, offsetof(ccV3F_C4B_T2F, texCoords)),
    ...
    _setupVBOandVAO: function() {
        ...
        glVertexAttribPointer(kCCVertexAttrib_Position, 2, GL_FLOAT, GL_FALSE, e, offsetof(ccV3F_C4B_T2F, vertices)),
        glEnableVertexAttribArray(kCCVertexAttrib_Color),
        glVertexAttribPointer(kCCVertexAttrib_Color, 4, GL_UNSIGNED_BYTE, GL_TRUE, e, offsetof(ccV3F_C4B_T2F, colors)),
        glEnableVertexAttribArray(kCCVertexAttrib_TexCoords),
        glVertexAttribPointer(kCCVertexAttrib_TexCoords, 2, GL_FLOAT, GL_FALSE, e, offsetof(ccV3F_C4B_T2F, texCoords)),
        glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, this._buffersVBO[1]),
    ...
    _allocMemory: function() {
        ...
        this._quads = [],
        this._indices = [];
        for (var e = 0; e < this._totalParticles; e++) this._quads[e] = new cc.V3F_C4B_T2F_Quad(),
        this._indices[e * 6] = 0,
        this._indices[e * 6 + 1] = 0,
        this._indices[e * 6 + 2] = 0,
        this._indices[e * 6 + 3] = 0,
        this._indices[e * 6 + 4] = 0,
        this._indices[e * 6 + 5] = 0;
...
cc.ParticleSystemQuad.create = function(e) {
    ...
    if (!e || typeof e == "number") {
        var n = e || 100;
        return t.setDrawMode(cc.PARTICLE_TEXTURE_MODE),
        t.initWithTotalParticles(n),
        t
    }
...
cc.ParticleBatchNode = cc.Node.extend({
    ...
    _textureAtlas: null,
    initWithTexture: function(e, t) {
        return this._textureAtlas = new cc.TextureAtlas(),
        this._textureAtlas.initWithTexture(e, t),
        this._children = [],
        this._blendFunc.src = cc.BLEND_SRC,
        this._blendFunc.dst = cc.BLEND_DST,
    ...
    addChild: function(e, t, n) {
        ...
        case 3:
            cc.Assert(e != null, "Argument must be non-NULL"),
            cc.Assert(e instanceof cc.ParticleSystem, "cc.ParticleBatchNode only supports cc.QuadParticleSystems as children"),
            cc.Assert(e.getTexture() == this._textureAtlas.getTexture(), "cc.ParticleSystem is not using the same texture id");
            if (this._children.length == 0) {
    ...
    insertChild: function(e, t) {
        e.setAtlasIndex(t),
        this._textureAtlas.getTotalQuads() + e.getTotalParticles() > this._textureAtlas.getCapacity() && (this._increaseAtlasCapacityTo(this._textureAtlas.getTotalQuads() + e.getTotalParticles()), this._textureAtlas.fillWithEmptyQuadsFromIndex(this._textureAtlas.getCapacity() - e.getTotalParticles(), e.getTotalParticles())),
        e.getAtlasIndex() + e.getTotalParticles() != this._textureAtlas.getTotalQuads() && this._textureAtlas.moveQuadsFromIndex(t, t + e.getTotalParticles()),
        this._textureAtlas.increaseTotalQuadsWith(e.getTotalParticles()),
        this._updateAllAtlasIndexes()
    },
    removeChild: function(e, t) {
        if (e == null) return;
        cc.Assert(e instanceof cc.ParticleSystem, "cc.ParticleBatchNode only supports cc.QuadParticleSystems as children"),
        cc.Assert(this._children.indexOf(e) > -1, "cc.ParticleBatchNode doesn't contain the sprite. Can't remove it"),
        this._super(e, t),
        this._textureAtlas.removeQuadsAtIndex(e.getAtlasIndex(), pChild.getTotalParticles()),
        this._textureAtlas.fillWithEmptyQuadsFromIndex(this._textureAtlas.getTotalQuads(), e.getTotalParticles()),
        e.setBatchNode(null),
        this._updateAllAtlasIndexes()
    },
    reorderChild: function(e, t) {
        cc.Assert(e != null, "Child must be non-NULL"),
        cc.Assert(e instanceof cc.ParticleSystem, "cc.ParticleBatchNode only supports cc.QuadParticleSystems as children");
        if (t == e.getZOrder()) return;
        if (this._children.length > 1) {
            var n = this._getCurrentIndex(e, t);
            if (n.oldIndex != n.newIndex) {
                cc.ArrayRemoveObjectAtIndex(this._children, n.oldIndex),
                this._children = cc.ArrayAppendObjectToIndex(this._children, e, n.newIndex);
                ...
                this._textureAtlas.moveQuadsFromIndex(r, e.getTotalParticles(), i),
                e.updateWithNoTime()
            }
        }
        e._setZOrder(t)
    ...
    setTexture: function(e) {
        this._textureAtlas.setTexture(e),
        e && !e.hasPremultipliedAlpha() && m_tBlendFunc.src == gl.BLEND_SRC && m_tBlendFunc.dst == gl.BLEND_DST && (this._blendFunc.src = gl.SRC_ALPHA, this._blendFunc.dst = gl.ONE_MINUS_SRC_ALPHA)
    },
    setBlendFunc: function(e, t) {
        arguments.length == 1 ? this._blendFunc = e: this._blendFunc = {
            src: e,
    ...
    _updateAllAtlasIndexes: function() {
        ...
        for (var t = 0; t < this._children[0].length; t++) {
            ...
            n.setAtlasIndex(e),
            e += n.getTotalParticles()
        }
    },
    _increaseAtlasCapacityTo: function(e) {
        cc.log("cocos2d: cc.ParticleBatchNode: resizing TextureAtlas capacity from [" + this._textureAtlas.getCapacity() + "] to [" + e + "]."),
        this._textureAtlas.resizeCapacity(e) || (cc.log("cocos2d: WARNING: Not enough memory to resize the atlas"), cc.Assert(!1, "XXX: cc.ParticleBatchNode #increaseAtlasCapacity SHALL handle this assert"))
    },
    ...
    _addChildHelper: function(e, t, n) {
        ...
        cc.Assert(e.getParent() == null, "child already added. It can't be added again"),
        this._children || (this._children = []);
        var r = this._searchNewPositionInChildrenForZ(t);
        return this._children = cc.ArrayAppendObjectToIndex(this._children, e, r),
        e.setTag(n),
        e._setZOrder(t),
        e.setParent(this),
        this._running && (e.onEnter(), e.onEnterTransitionDidFinish()),
        r
    },
    _updateBlendFunc: function() {
        this._textureAtlas.getTexture().hasPremultipliedAlpha() || (this._blendFunc.src = gl.SRC_ALPHA, this._blendFunc.dst = gl.ONE_MINUS_SRC_ALPHA)
...
cc.TouchHandler = cc.Class.extend({
    ...
    initWithDelegate: function(e, t) {
        return cc.Assert(e != null, "TouchHandler.initWithDelegate():touch delegate should not be null"),
        this._delegate = e,
        this._priority = t,
...
cc.TouchDispatcher = cc.Class.extend({
    ...
    forceAddHandler: function(e, t) {
        ...
        for (var r = 0; r < t.length; r++) {
            ...
            if (i) {
                ...
                if (i.getDelegate() == e.getDelegate()) return cc.Assert(0, "TouchDispatcher.forceAddHandler()"),
                t
            }
        }
    ...
    setPriority: function(e, t) {
        ...
        cc.Assert(n != null, "TouchDispatcher.setPriority():Cant find TouchHandler"),
        n.getPriority() != e && (n.setPriority(e), this.rearrangeHandlers(this._targetedHandlers), this.rearrangeHandlers(this._standardHandlers))
    },
    touches: function(e, t, n) {
        cc.Assert(n >= 0 && n < 4, "TouchDispatcher.touches()"),
        this._locked = !0;
                ...
                for (var c = 0; c < this._targetedHandlers.length; c++) {
                    ...
                    if (n == cc.TOUCH_BEGAN) l.getDelegate().onTouchBegan && (h = l.getDelegate().onTouchBegan(a, t), h && l.getClaimedTouches().push(a));
                        ...
                        case cc.TOUCH_MOVED:
                            ...
                            break;
                        case cc.TOUCH_ENDED:
                            l.getDelegate().onTouchEnded && l.getDelegate().onTouchEnded(a, t),
                            l.getClaimedTouches().length = 0;
                            break;
                        case cc.TOUCH_CANCELLED:
                            l.getDelegate().onTouchCancelled && l.getDelegate().onTouchCancelled(a, t),
                            l.getClaimedTouches().length = 0
                        }
                    }
...
cc.getHTMLElementPosition = function(e) {
    ...
    while (e != null) t.left += e.offsetLeft,
    t.top += e.offsetTop,
    e = e.offsetParent;
    return t
},
cc.ProcessMouseupEvent = function(e, t) {
    ...
    u = new cc.Touch(s, o);
    u._setPrevPoint(cc.TouchDispatcher.preTouchPoint.x, cc.TouchDispatcher.preTouchPoint.y),
    cc.TouchDispatcher.preTouchPoint.x = s,
    cc.TouchDispatcher.preTouchPoint.y = o;
    var a = [];
    a.push(u),
    cc.Director.getInstance().getTouchDispatcher().touchesEnded(a, null)
},
cc.TouchDispatcher.registerHtmlElementEvent = function(e) {
    if (cc.TouchDispatcher.isRegisterEvent) return;
    cc.Browser.isMobile ? (e.addEventListener("touchstart",
    function(t) {
        if (!t.touches) return;
        var n = [],
        ...
        for (var i = 0; i < t.touches.length; i++) {
            ...
            f = null;
            t.touches[i].hasOwnProperty("identifier") ? f = new cc.Touch(u, a, t.touches[i].identifier) : f = new cc.Touch(u, a),
            f._setPrevPoint(cc.TouchDispatcher.preTouchPoint.x, cc.TouchDispatcher.preTouchPoint.y),
            cc.TouchDispatcher.preTouchPoint.x = u,
            cc.TouchDispatcher.preTouchPoint.y = a,
            n.push(f)
        }
        cc.Director.getInstance().getTouchDispatcher().touchesBegan(n, null),
        t.stopPropagation(),
        t.preventDefault()
    },
    ...
    function(t) {
        ...
        cc.Director.getInstance().getTouchDispatcher().touchesMoved(n, null),
        t.stopPropagation(),
        t.preventDefault()
    },
    ...
    function(t) {
        ...
        for (var s = 0; s < i.length; s++) {
            ...
            l = null;
            i[s].hasOwnProperty("identifier") ? l = new cc.Touch(a, f, i[s].identifier) : l = new cc.Touch(a, f),
            l._setPrevPoint(cc.TouchDispatcher.preTouchPoint.x, cc.TouchDispatcher.preTouchPoint.y),
            cc.TouchDispatcher.preTouchPoint.x = a,
            cc.TouchDispatcher.preTouchPoint.y = f,
            n.push(l)
        }
        cc.Director.getInstance().getTouchDispatcher().touchesEnded(n, null),
        t.stopPropagation(),
        t.preventDefault()
    },
    ...
    function(t) {
        ...
        cc.Director.getInstance().getTouchDispatcher().touchesCancelled(n, null),
        t.stopPropagation(),
        t.preventDefault()
    },
    ...
    function(t) {
        ...
        var a = [];
        a.push(u),
        cc.Director.getInstance().getTouchDispatcher().touchesBegan(a, null)
    ...
    function(t) {
        ...
        var a = [];
        a.push(u),
        cc.Director.getInstance().getTouchDispatcher().touchesMoved(a, null)
    })),
...
cc.MouseDispatcher = cc.Class.extend({
    ...
    setPriority: function(e, t) {
        ...
        cc.Assert(n != null, "MouseDispatcher.setPriority():Cant find MouseHandler"),
        n.getPriority() != e && (n.setPriority(e), this._mouseDelegateHandlers.sort(cc.less))
    },
...
cc.MouseDispatcher._registerHtmlElementEvent = function(e) {
    function t(t) {
        ...
        o = (n.height - (i - n.top)) / cc.Director.getInstance().getContentScaleFactor(),
        u = new cc.Mouse(s, o);
        return u._setPrevPoint(cc.MouseDispatcher._preMousePoint.x, cc.MouseDispatcher._preMousePoint.y),
        u.setButton(t.button),
        cc.MouseDispatcher._preMousePoint.x = s,
        cc.MouseDispatcher._preMousePoint.y = o,
        u
    }
